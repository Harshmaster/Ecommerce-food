                              ...
                              children: <Widget>[
                                ...
                                "numberCC",
                                    ...
                                    style: _txtCustomSub.copyWith(
                                        color: Colors.white)),
                                Text(
                                  // AppLocalizations.of(context).tr('cvCC'),
                                  "cvCC",
                                    style: _txtCustomSub.copyWith(
                                        color: Colors.white)),
                              ],
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 5.0),
                        child: Text(
                          // AppLocalizations.of(context).tr('nameCC'),
                          "nameCC",
                        )
                      ),
                    ],
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            dataTransaction(
              date: 
              // AppLocalizations.of(context).tr('datePayment1'),
              "datePayment1",
              item: 
              // AppLocalizations.of(context).tr('itemPayment1'),
              "itemPayment1",
              price: "\$ 50",
            ),
            dataTransaction(
              date: 
              // AppLocalizations.of(context).tr('datePayment2'),
              "datePayment2",
               item:
              //  AppLocalizations.of(context).tr('itemPayment2'),
              "itemPayment2",
              price: "\$ 1000",
            ),
            dataTransaction(
              date:
              //  AppLocalizations.of(context).tr('datePayment3'),
               "datePayment3",
              item:
              //  AppLocalizations.of(context).tr('itemPayment3'),
               "itemPayment3",
              price: "\$ 2500",
            ),
            dataTransaction(
               date:
              //  AppLocalizations.of(context).tr('datePayment4'),
              "datePayment4",
              item:
              //  AppLocalizations.of(context).tr('itemPayment4'),
              "itempayment4",
              price: "\$ 50",
            ),
            dataTransaction(
              date:
              //  AppLocalizations.of(context).tr('datePayment5'),
              "datePayment5",
              item: 
              // AppLocalizations.of(context).tr('itemPayment5'),
              "itemPayment5",
              price: "\$ 50",
            ),
          ],
