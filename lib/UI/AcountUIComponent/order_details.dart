              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: <Widget>[
                     date ==null ?Text("Date"):   Text(date.toDate().day.toString() +
                            "-" +
               ...
               Row(
                ...
                style: TextStyle(
                 ...
                 Padding(
                padding: const EdgeInsets.symmetric(vertical: 8,horizontal: 20),
                child: Text(status == null ? "STATUS": status.toUpperCase(),
                style: TextStyle(
                  fontSize: 20,
                  color: Colors.green,
                  fontWeight: FontWeight.w600
...
String msg = "Hello, I am having issue with order id $id.";
               Navigator.of(context).push(
                      PageRouteBuilder(pageBuilder: (_, __, ___) => new chatItem(message: msg,)));
            }, child:
