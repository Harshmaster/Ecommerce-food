...
import 'package:kirana_app/Library/Expanded/ExpandedDetailRatting.dart';
import 'package:kirana_app/Library/Expanded/ExpandedDetailReviews.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child:  Text("reviewsAppBar",style: TextStyle(color: Colors.black,fontSize: 20.0,fontFamily: "Popins",fontWeight: FontWeight.w700),),
                  ),
                  Padding(
                  ...
                  ListTile(
                    ...
                    subtitle:  ExpansionTileReview(
                      title:Text(
                        "Rating review",style: _detailText,
                      ),
                      children:[
                        SizedBox(height: 10.0),
                        Text("rating review",style: _detailText,),
                        SizedBox(height: 10.0),
                        Text("rating review",style: _detailText,),
                      ],
