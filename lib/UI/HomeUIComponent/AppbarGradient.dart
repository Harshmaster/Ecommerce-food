...
import 'package:kirana_app/UI/AcountUIComponent/Message.dart';
import 'package:kirana_app/UI/AcountUIComponent/Notification.dart';
            ...
            InkWell(
              onTap: () {
                Navigator.of(context).push(PageRouteBuilder(
                    ...
                    //     Navigator.of(context).push(PageRouteBuilder(
                    // pageBuilder: (_, __, ___) => new FacultyContactPage()));
              },
              child: Stack(
